...
export default function AppDownload() {
  ...
  return (
    <section ref={ref} id="app" className={`section-pad${vis ? ' reveal visible' : ' reveal'}`}>
      <div className="app-inner">
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.8rem,3.5vw,2.8rem)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-0.03em', marginBottom: '1rem' }}>
            Descarga<br />FASTY <span style={{ color: 'var(--lime)' }}>App</span>
          </h2>
          <p style={{ color: 'var(--muted)', lineHeight: 1.6, marginBottom: '2rem' }}>
            Pide comida, compra productos y recibe entregas rápidas desde tu celular. La mejor experiencia de delivery en Quibdó.
          </p>
          <div className="app-btns" style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <StoreBtn icon="🤖" store="Google Play" />
            <StoreBtn icon="🍎" store="App Store" />
          </div>
        </div>

        {/* phones — se ocultan en mobile via CSS */}
        <div className="app-phones-col">
