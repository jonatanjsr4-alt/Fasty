  ...
  <div className="glass-card px-5 py-3 rounded-full text-sm text-orange-400 font-semibold">
    🏪 +500 negocios
        ...
        <motion.p
          ...
          className="mt-10 text-lg md:text-xl text-gray-300 max-w-3xl"
        >
        ...
        <div className="flex flex-col md:flex-row gap-5 mt-12">
          ...
          <button className="premium-button bg-orange-500 hover:bg-orange-600 transition-all px-9 py-4 rounded-2xl font-bold text-lg shadow-xl shadow-orange-500/40">
            Pedir Ahora
          </button>

          <button className="premium-button border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white transition-all px-9 py-4 rounded-2xl font-bold text-lg">
            Registrar Negocio
          </button>
